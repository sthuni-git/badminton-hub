...
export const CRAWLER_SOURCES: CrawlerSource[] = [
  ...
  // 3. 네이버 밴드 & 커뮤니티
  {
    ...
    difficulty: '보통',
    phase: 'Phase 1 (쉬움/즉시수집)',
    method: '공개 밴드 웹 피드 크롤링 & 지능형 요강 본문 텍스트 파싱',
    recommendedTool: 'Playwright / Cheerio / Regex NLP Parser',
    collectedData: '전국 오픈 토너먼트 포스터, 네이버폼/구글폼 접수 링크, 클럽 대항전 공지',
    description: '전국 배드민턴 동호회와 주최 측이 직접 대회 포스터와 신청서를 실시간으로 업로드하는 최대 공개 커뮤니티 채널입니다.',
  },
  {
    id: 'cafe_market',
