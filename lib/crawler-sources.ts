...
export const CRAWLER_SOURCES: CrawlerSource[] = [
  ...
  // 3. 네이버 밴드 & 커뮤니티
  {
    id: 'band_mintoncontest',
    name: '네이버 밴드 (@mintoncontest)',
    category: '네이버 밴드 & 커뮤니티',
    targetUrl: 'https://band.us/@mintoncontest',
    difficulty: '어려움',
    phase: 'Phase 3 (어려움/폐쇄형)',
    method: '네이버 로그인 세션 유지 or 모바일 뷰 파싱',
    recommendedTool: 'Playwright (쿠키 탑재)',
    collectedData: '전국 단위 배드민턴 대회 포스터 및 신규 접수 공지',
    description: '동호인 주최 측이 직접 포스터와 신청서를 실시간으로 업로드하는 최대 채널 중 하나입니다.',
  },
  {
    id: 'band_main',
    name: '네이버 밴드 (배드민턴 대회 밴드)',
    category: '네이버 밴드 & 커뮤니티',
    targetUrl: 'https://band.us/band/63083777',
    subUrls: ['https://band.us/band/65702481'],
    difficulty: '어려움',
    phase: 'Phase 3 (어려움/폐쇄형)',
    method: '로그인 세션 유지 / Playwright',
    recommendedTool: 'Playwright + 계정 쿠키',
    collectedData: '생활체육 오픈 대회 및 지역 대회 요강, 댓글 접수 링크',
    description: '사설 오픈 및 지역 클럽 교류전 요강이 활발하게 공유되는 커뮤니티입니다.',
  },
  {
    id: 'cafe_market',
